    ...
    return (
        <div className="card">
            <div className="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                ...
                <div className="d-flex flex-wrap align-items-center gap-3">
                    <Link to="/dealer-receipts/add" className="btn btn-sm btn-primary-600">
                        <i className="ri-add-line" /> Add Dealer Receipt
                    </Link>
                </div>
            </div>
...
export default ViewDealerReceiptsLayer;
